    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{exampleblock}{O Presente e Futuro}
                A inteligência bruta e técnica agora está *"disponível na torneira"*. Qual o verdadeiro diferencial?
            \end{exampleblock}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \begin{block}{Em Termos Práticos...}
                \begin{itemize}
                    \item A capacidade não de ler o projeto em PDF, mas de arriscar a **primeira reunião com uma prefeitura local**.
...
\begin{frame}{Inovação Fomentada pelas Ações da Unesp}
    ...
    \begin{block}{Fomento (Resolução 13/2025 - Inovação)}
        \begin{itemize}
            \item \textbf{Parcerias Públicas e Externas:} Autorização e norte seguro para incubadoras tecnológicas, garantindo o "DNA" da Unesp em inovações colaborativas conjuntas com *stakeholders* externos.
