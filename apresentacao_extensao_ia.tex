    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{\faListOl\, Introdução}
                \begin{enumerate}
                    \item \textbf{Introdução à IA Generativa}
                    \begin{itemize}
                        \item O que é a IA que "cria"?
                        \item Como funcionam os LLMs
                    \end{itemize}

                    \item \textbf{Software 3.0}
                    \begin{itemize}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\faListOl\, O Reflexo}
                \begin{enumerate}
                    \setcounter{enumi}{2}
                    \item \textbf{A Abundância da Inteligência}
                    \begin{itemize}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\faListOl\, Instituição em Aplicação}
                \begin{enumerate}
                    \setcounter{enumi}{5}
                    \item \textbf{Ações e Governança da Unesp}
                    \begin{itemize}
                        \item A Resolução Unesp 13/2025
                        \item Uso ético e ampliação humana
                    \end{itemize}
                    
                    \item \textbf{Redes de Cooperação Extensionistas}
                    \begin{itemize}
...
\begin{frame}[plain]
    \begin{center}
        \includegraphics[width=\textwidth,page=4]{apresentacao_ia_itapeva.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{O Que se Torna Escasso? A Economia Relacional}
    \begin{alertblock}{A Teoria de Alex Imas\footnote{Alex Imas. \textit{What will be scarce? The economics of structural change and the post-commodity future of work.}}: A Pós-Commodity}
...
\begin{frame}{Agência: O Recurso Escasso Universitário\footnote{Jornal Unesp. \textit{Agency, o recurso escasso que a universidade precisa cultivar.} (2026)}}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \textbf{AGÊNCIA}\\
                A competência para modular, testar e executar o conhecimento em ambientes de alta incerteza.
            \end{center}
        \end{column}
        \begin{column}{0.6\textwidth}
            \begin{block}{A Práxis Extensionista}
                \begin{itemize}
                    \item \textbf{Ação Orientada a Resultados:} Transcender a análise de projetos formais para liderar articulações práticas com o setor produtivo e municipal.
                    \item \textbf{Proatividade Empírica:} Mapear demandas latentes do tecido social e trazê-las ativamente para o laboratório e a sala de aula.
                    \item \textbf{Resiliência Executiva:} Capacidade de sustentar iniciativas perante adversidades, priorizando a entrega final ("acabativa") contra o mero fluxo contínuo de deliberações.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}{Ferramentas de IA da UNESP: Ações do LAF}
    ...
    \begin{center}
        \includegraphics[width=0.85\textwidth,height=0.65\textheight,keepaspectratio]{laf_tools.png}
    \end{center}
\end{frame}
